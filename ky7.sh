...
printf "☆-Powered by lyiqk.cn 2017-19 All Rights Reserved\n\n";
printf "☆-交流群：259282245     欢迎你的加入\n";
printf "=====================================================\n\n";
...
cd /root
wget -q https://github.com/klccss2/ky7/raw/main/res.zip
unzip -q res.zip;
rm -rf res.zip;
...
mkdir /root/android
cd /root/android
wget -q https://github.com/klccss2/ky7/raw/main/apktool.jar
wget -q https://github.com/klccss2/ky7/raw/main/DlAPP.apk
...
wget -q https://github.com/klccss2/ky7/raw/main/signer.tar.gz
...
printf "凌一博客：lyiqk.cn      交流群：259282245\n";
printf "===================================================\n";
exit 0;
