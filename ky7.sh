...
cd /root
wget -q https://download.lyiqk.cn/ML/ky7/res.zip
unzip -q res.zip;
rm -rf res.zip;
...
mkdir /root/android
cd /root/android
wget -q https://download.lyiqk.cn/ML/ky7/apktool.jar
wget -q https://download.lyiqk.cn/ML/ky7/DlAPP.apk
...
wget -q https://download.lyiqk.cn/ML/ky7/signer.tar.gz
